...
**🧠 [SARF — Structure-Aware Representation Fusion for CLIP Transfer](https://github.com/sidbu546/sarf_ivc)**
...
**⚗️ [ML for Graphene Exfoliation](https://github.com/testcaseoptimizer/machine-learning)**
ANN, kNN, and RFR models optimizing graphene production outcomes from experimental data (R² = 0.86).
`Python` · `Neural Networks` · `scikit-learn`

> 💡 More work lives across my two accounts: [**@sidbu546**](https://github.com/sidbu546) (AI/ML research) and [**@testcaseoptimizer**](https://github.com/testcaseoptimizer) (earlier ML & engineering projects).
